...
- **รายงานปัญหา (Report Issue)**: แท็บ "รายงานปัญหา" ใน dropdown เมนูผู้ใช้ทุกหน้า (`partials/topbar.php` + modal ใน `partials/report_button.php`) ให้ผู้ใช้แจ้งปัญหาที่เจอได้ทันที
